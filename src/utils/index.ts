...
export function getEnvBaseUrl() {
  ...
  const VITE_SERVER_BASEURL__WEIXIN_DEVELOP = 'http://localhost:1337'
  const VITE_SERVER_BASEURL__WEIXIN_TRIAL = 'http://localhost:1337'
  const VITE_SERVER_BASEURL__WEIXIN_RELEASE = 'http://localhost:1337'
...
export function getEnvBaseUploadUrl() {
  ...
  const VITE_UPLOAD_BASEURL__WEIXIN_DEVELOP = 'http://localhost:1337'
  const VITE_UPLOAD_BASEURL__WEIXIN_TRIAL = 'http://localhost:1337'
  const VITE_UPLOAD_BASEURL__WEIXIN_RELEASE = 'http://localhost:1337'
